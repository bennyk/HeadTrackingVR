...
struct CubeApp : public MyGlApp{
  ...
  virtual void onDraw(){
    ...
    float ratio = (float)ANativeWindow_getWidth(window()) / ANativeWindow_getHeight(window());
    glm::mat4 proj = glm::perspective( 3.14f / 3.f, ratio, 0.1f,-10.f);
